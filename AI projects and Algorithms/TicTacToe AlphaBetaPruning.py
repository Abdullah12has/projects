# Syed Abdullah Hassan, Hasaan Ijaz, Mohammad Usayrim Rehman, Kenan Şahin, Baran Uslu  - AI 
#Homework 3
...
easy = 49
hard = 200000  # min nodes to be unbeatable
...
class ComputerPlayer(Player):
    ...
    def GetMove(self):
        ...
        print(str(self.loop) + "\tmoves")  #  print move combos
        print("\nTurn", self.turn)
        if self.cutoff:
...
if(__name__ == "__main__"):
    difficulty = input(" 1. Player 1 wins \n 2. Player 2 wins \n 3. Draw \n Which Case do you want to see: ").lower()
    pygame.init()  # initialization
    boardsize = 500  # board size
    # screen display
    screen = pygame.display.set_mode((boardsize, boardsize + 35))
    pygame.display.set_caption('Tic Tac Toe')  # name
    ...
    if difficulty == "1":
        ...
        game.AddPlayer(ComputerPlayer(O, "Player 1", easy))  # player 1
        game.AddPlayer(ComputerPlayer(X, "Player 2", easy))  # player 2
        
    elif difficulty == "2":
        game.AddPlayer(ComputerPlayer(O, "Player 1", easy))  # player 1
        game.AddPlayer(ComputerPlayer(X, "Player 2", hard))  # player 2
    else:
        game.AddPlayer(ComputerPlayer(O, "Player 1", hard))  # player 1
        game.AddPlayer(ComputerPlayer(X, "Player 2", hard))  # player 2
    while not gameover:
